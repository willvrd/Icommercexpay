<div class="featured-img">
    ...
    <div data-preview="#{{$name}}" data-aspectRatio="0" data-crop="{{$crop}}" class="form-group image col-md-12">
        <div>
            <label>{{trans('icommerce::paymentmethods.table.featured image')}}</label>
        </div>
        ...
        <div class="row">
            <div class="col-sm-6" style="margin-bottom: 20px;">
                ...
                @if(isset($method) && ($method!=null) && isset($method->options->mainimage))
                    <img id="mainImage" src="{{url($method->options->mainimage)}}">
                @else
